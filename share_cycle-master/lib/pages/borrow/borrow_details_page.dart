          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  "${S.of(context).lender_name}：${widget.data["name"]}",
              ...
              if (widget.data['state'] == 1) Text("${S.of(context).the_item_has_been_lent_out}"),
                  ...
                  ? Container(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            ...
                            child: Text(
                              "${S.of(context).off_shelf}", // take down from the shelves
                              style: TextStyle(fontSize: 20),
                            )), //Currently own item, can't apply
                      ],
                    ))
                  : Container(
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            ...
                            // Determine if the product is your own
                            if (widget.data['user_id'] == userBean?.id.toString()) {
  ...
  getReturnData() async {
    ...
    for (var value in docs) {
      returnData.add({
        ...
        "lender_comment": value.get("lender_comment"),
        "borrowed_comment": value.get("borrowed_comment"),
