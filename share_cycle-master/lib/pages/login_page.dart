...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget itemBtn(
      {required IconData icon, required String text, required Function click}) {
    return Container(
  ...
  loginUser() async {
    ...
    dynamic userJson = {
      ...
      "username": "${queryDocumentSnapshot["user_name"]}",
